...
<html>
    ...
    <tr>
        ...
        <?php
        $sql1 = "SELECT C.cust_name, S.shop_name, T.treat_name, P.pet_name, B.book_date, B.book_id, B.date, B.slot_time,
        B.total_price from `shops` as S , `shoptreat` as X, `treatlist` as T,`pets` as P,
         `booking` as B, `customer` as C WHERE B.shop_id=S.shop_id and
